...
var themes = [ [ "#FFFFFF", "#7777fa", "#777", "#f97878", "#78a7f9" ],
		[ "#000000", "#f97878", "#78a7f9", "#7777fa", "#777" ] ];
var theme;
...
function reset() {
	...
	var images = ["img/alvin.jpg","img/lauren.jpg","img/marius.jpg","img/petter.jpg","img/alex.jpg","img/daniel.jpg","img/max.jpg"];
	
	for (var i = 0; i < images.length; i++) {
		console.log(images[i]);
	  	createInstructions(images, i);
	};
	// createInstructions(images);
	// createInstructions2(images);
	// console.log(bodies);
